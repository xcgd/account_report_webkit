    ...
    <body>
        ...
        <div class="act_as_table data_table">
            <div class="act_as_row labels">
                ...
                %if currency_filter:
                	<div class="act_as_cell">${_('Currency Filter')}</div>
            	%endif
                <div class="act_as_cell">${_('Target Moves')}</div>
                <div class="act_as_cell">${_('Allocated')}</div>
                %if analytic_codes:
                	<div class="act_as_cell">${_('Analytic dimension')}</div>
            	%endif
            </div>
            <div class="act_as_row">
                ...
                <div class="act_as_cell">
                 ...
                 %if currency_filter:
                	<div class="act_as_cell">${currency_filter}</div>
            	%endif
                <div class="act_as_cell">${ display_target_move(data) }</div>
                <div class="act_as_cell">${ allocated }</div>
                %if analytic_codes:
                	<div class="act_as_cell">${analytic_codes}</div>
            	%endif
            </div>
        </div>
            ...
            <div class="act_as_table list_table" style="margin-top: 10px;">
                ...
                <div class="act_as_thead">
                    <div class="act_as_row labels">
                        ...
                        ## label
                        <div class="act_as_cell" style="width: 375px;">${_('Label')}</div>
                        ## debit
                ...
                <div class="act_as_tbody">
                      ...
                      <div class="act_as_row lines">
                          ...
                          ## account code
                          <div class="act_as_cell">${line.get('orig_account') if analytic_codes else account.code}</div>
                          ## partner
                ...
                <div class="act_as_table list_table">
                    <div class="act_as_row labels" style="font-weight: bold;">
                        ...
                        <div class="act_as_cell" style="width: 440px; text-align: right; padding-right: 20px;">${_("Total")}</div>
                        ## debit
